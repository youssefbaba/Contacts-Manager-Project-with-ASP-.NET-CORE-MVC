...
namespace Testing
{
    public class StocksServiceTest
    {
        ...
        [Fact]
        public void CreateBuyOrder_BuyOrderQuantityIsLessThan1()
        {
            // Arrange
        ...
        [Fact]
        public void CreateBuyOrder_BuyOrderQuantityIsGreaterThan100000()
        {
            // Arrange
            BuyOrderRequest buyOrderRequest = new BuyOrderRequest()
            {
        ...
        [Fact]
        public void CreateBuyOrder_BuyOrderPriceIsLessThan1()
        {
            // Arrange
            BuyOrderRequest buyOrderRequest = new BuyOrderRequest()
            {
        ...
        [Fact]
        public void CreateBuyOrder_BuyOrderPriceIsGreaterThan10000()
        {
            // Arrange
            BuyOrderRequest buyOrderRequest = new BuyOrderRequest()
            {
        ...
        [Fact]
        public void CreateBuyOrder_DateAndTimeOfOrderOlderThan2000()
        {
            // Arrange
            BuyOrderRequest buyOrderRequest = new BuyOrderRequest()
            {
        ...
        [Fact]
        public void CreateSellOrder_SellOrderQuantityIsLessThan1()
        {
            // Arrange
        ...
        [Fact]
        public void CreateSellOrder_SellOrderQuantityIsGreaterThan100000()
        {
            // Arrange
            SellOrderRequest sellOrderRequest = new SellOrderRequest()
            {
        ...
        [Fact]
        public void CreateSellOrder_SellOrderPriceIsLessThan1()
        {
            // Arrange
            SellOrderRequest sellOrderRequest = new SellOrderRequest()
            {
        ...
        [Fact]
        public void CreateSellOrder_SellOrderPriceIsGreaterThan10000()
        {
            // Arrange
            SellOrderRequest sellOrderRequest = new SellOrderRequest()
            {
        ...
        // When we supply dateAndTimeOfOrder as "1999-12-31" (YYYY-MM-DD) - (as per the specification, it should be equal or newer date than 2000-01-01), it should throw ArgumentException.
        [Fact]
        public void CreateSellOrder_DateAndTimeOfOrderOlderThan2000()
        {
            // Arrange
            SellOrderRequest sellOrderRequest = new SellOrderRequest()
            {
