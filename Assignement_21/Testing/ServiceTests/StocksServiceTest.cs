...
using ServiceLayer.StocksService;
...
namespace Testing.ServiceTests
{
    public class StocksServiceTest
    {
        ...
        public async Task CreateBuyOrder_ProperBuyOrderDetails_ToBeSuccessful()
        {
            ...
            // Act
            BuyOrderResponse actualBuyOrderResponse = await _buyOrdersService.CreateBuyOrder(buyOrderRequest);
        ...
        public async Task CreateSellOrder_ProperSellOrderDetails_ToBeSuccessful()
        {
            ...
            // Act
            SellOrderResponse actualSellOrderResponse = await _sellOrdersService.CreateSellOrder(sellOrderRequest);
        ...
        public async Task GetBuyOrders_BuyOrdersIsEmpty_ToBeEmptyList()
        {
            ...
            // Act
            List<BuyOrderResponse> actualBuyOrderResponses = await _buyOrdersService.GetBuyOrders();
        ...
        public async Task GetBuyOrders_WithFewBuyOrders_ToBeSuccessful()
        {
            ...
            // Act
            List<BuyOrderResponse> actualBuyOrderResponseList = await _buyOrdersService.GetBuyOrders();
        ...
        public async Task GetSellOrders_SellOrdersIsEmpty_ToBeEmptyList()
        {
            ...
            // Act
            List<SellOrderResponse> actualSellOrderResponseList = await _sellOrdersService.GetSellOrders();
